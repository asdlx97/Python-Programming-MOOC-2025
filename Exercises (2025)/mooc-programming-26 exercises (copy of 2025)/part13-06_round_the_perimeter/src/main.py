...
while True:
    ...
    ##Movement boundaries
    if robot_velocity_x > 0 and robot_x+robot_w >= window_w:
        robot_velocity_x = 0
        robot_velocity_y = 1
    if robot_velocity_x < 0 and robot_x <= 0: 
        robot_velocity_x = 0
        robot_velocity_y = -1
    if robot_velocity_y > 0 and robot_y+robot_h >= window_h:
        robot_velocity_x = -1
        robot_velocity_y = 0
    if robot_velocity_y < 0 and robot_y <= 0: 
        robot_velocity_x = 1
        robot_velocity_y = 0
