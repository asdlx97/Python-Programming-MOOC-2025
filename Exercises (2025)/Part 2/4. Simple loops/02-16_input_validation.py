...
#Review
My solution results in same output, the suggested one just uses two separate if statements instead of elif.
This actually makes sense as it is exiting the loop if true, doesn't need to continue the if statement anymore.
Let's say it improves clarity if you keep logical checks separate.
"""