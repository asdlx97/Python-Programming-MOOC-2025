...
Please write a program which asks the user for a floating point number and then prints out 
the integer part and the decimal part separately. Use the Python int function.
...
#Review
My solution returns the same output, and uses the same script and logic.
"""