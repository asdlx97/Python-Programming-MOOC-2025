...
#Review
My solution results in the same output, suggested one uses the helper 
method to calculate the total weight in CargoHold too, as done in Suitcase.

Mine uses inline logic for the string formatting which is more clean and concise. My weight calculation
too is far more concise by using the sum() function. 
"""
