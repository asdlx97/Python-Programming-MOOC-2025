"""
Please write a function named older_book(book1: Book, book2: Book) which
takes two objects of type Book as its arguments. The function should print
out a message with the details of whichever is the older. It should print
out a different message if the two books were written in the same year.
...
#Review
My solution results in the same output, suggested one uses more flags
so it takes a bit more lines. My solution is a bit more clear and direct.
"""
